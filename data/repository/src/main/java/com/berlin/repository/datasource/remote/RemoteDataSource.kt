...
interface RemoteDataSource {
    ...
    suspend fun rateMovie(movieId: Int, sessionId: String, rating: SubmitRatingRequestDto): SubmitRatingResponse
    suspend fun rateTvShow(tvId: Int, sessionId: String, rating: SubmitRatingRequestDto): SubmitRatingResponse
}